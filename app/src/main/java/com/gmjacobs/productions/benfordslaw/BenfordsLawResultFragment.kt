 ...
 * Use the [BenfordsLawResultFragment.newInstance] factory method to
...
class BenfordsLawResultFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment BenfordsLawResultFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            BenfordsLawResultFragment().apply {
